...
<html lang="en">
  ...
  <x-staff-nav-bar />
    ...
    <form method='POST' action="{{route('personhistory')}}">
        ...
        <div class="mb-3">
            <label for="exampleInputEmail1" class="form-label">Vaccine:</label>
            <input type="text" class="form-control" name="nic" aria-describedby="emailHelp">
        </div>
        <div class="mb-3">
            <label for="exampleInputEmail1" class="form-label">Venue(s)</label>
            <input type="text" class="form-control" name="vp" aria-describedby="emailHelp">
        </div>
        <div class="mb-3">
            <label for="exampleInputEmail1" class="form-label">Age Group</label>
            <input type="number" class="form-control" name="bnum" aria-describedby="emailHelp">
        </div>
        <div class="mb-3">
            <label for="exampleInputEmail1" class="form-label">No. of dosage:</label>
